...
class dpodappFlyteApi {
    ...
    getAll = async (appflyte_details, last_evaluated_key) => {
        ...
        return AxiosObj.get(`/${this.accountId}/admin/api/collection/${this.accountId}/user/private/cm/v1/${this.schema_id}/user_app_accesss?filters=null&last_evaluated_key=${last_evaluated_key}&page_size=500&include_detail=false`)
    }
}
