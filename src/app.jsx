...
function App() {
    ...
    const appflyte_account_id = "0aee6bd7-ed42-4184-9bac-ce0466737ada"
    const appflyte_subscriber_id = "6551f605-39cb-4351-8ea1-b2a7af317985"
    const appflyte_subscription_id = "a6a49ce0-1121-455c-91cd-7956eb0891dd"
    const appflyte_organization_id = "424e744f-94a5-4aae-b1ae-f24719f1a426"
